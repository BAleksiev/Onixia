...
/* end template head */ ob_start(); /* template body */ ?>        <div id="content">
            <div class="page">
                <h2 class="title"><?php echo translate('Ships');?></h2>
...
?>err<?php 
                            ...
                            <div class="line">
                                ...
                                <div class="value"><?php if ($this->readVar("avShips.".(isset($this->scope["s"]["id"]) ? $this->scope["s"]["id"]:null))) {

echo $this->readVar("avShips.".(isset($this->scope["s"]["id"]) ? $this->scope["s"]["id"]:null));
