...
/* end template head */ ob_start(); /* template body */ ?>        <div id="content">
            <div class="page statistic">
                <h2 class="title"><?php echo translate('Statistic');?></h2>
                <table class="standart">
                    ...
                    <tbody>
                        <tr>
                            <td class="active res"><?php echo translate('From metal mines');?></td>
...
echo round((isset($this->scope["metalEnergyUse"]) ? $this->scope["metalEnergyUse"] : null));?></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('From crystal mines');?></td>
                            <td></td>
...
echo round((isset($this->scope["crystalEnergyUse"]) ? $this->scope["crystalEnergyUse"] : null));?></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('From gas mines');?></td>
                            <td></td>
                            <td></td>
...
echo round((isset($this->scope["gasEnergyUse"]) ? $this->scope["gasEnergyUse"] : null));?></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Used energy');?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Enrgy income');?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Enrgy from satelites');?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td class="active"></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Bonus from robots');?></td>
                            <td class="active"></td>
                            <td class="active"></td>
                            <td class="active"></td>
                            <td></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Bonus from energy systems');?></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Total');?></td>
                        ...
                        <tr>
                            <td class="active res"><?php echo translate('Storage capacity');?></td>
