...
?>style="color: #fff;"<?php 
                        ...
                        <li><a href="alliance.php" <?php if ((isset($this->scope["action"]) ? $this->scope["action"] : null) == 'alliance') {
?>style="color: #fff;"<?php 
}?>><?php echo translate('Alliance');?></a></li>
...
?>style="color: #fff;"<?php 
            ...
            <div class="nav">
                ...
                <div class="lines">
                    <ul>
                        <li><a href="profile.php" <?php if ((isset($this->scope["action"]) ? $this->scope["action"] : null) == 'profile') {
?>style="color: #fff;"<?php 
}?>><?php echo translate('Profile');?></a></li>
                        <li><a href="messages.php" <?php if ((isset($this->scope["action"]) ? $this->scope["action"] : null) == 'messages' && (isset($this->scope["subaction"]) ? $this->scope["subaction"] : null) != 'sent') {
?>style="color: #fff;"<?php 
}?>><?php echo translate('Messages');?> <?php if ((isset($this->scope["newMessages"]) ? $this->scope["newMessages"] : null)) {
?>[<?php echo $this->scope["newMessages"];?>]<?php 
}?></a></li>
                        <li><a href="messages.php?type=sent" <?php if ((isset($this->scope["action"]) ? $this->scope["action"] : null) == 'messages' && (isset($this->scope["subaction"]) ? $this->scope["subaction"] : null) == 'sent') {
?>style="color: #fff;"<?php 
