                    ...
                    <div class="main">
                        <div class="panel">
                            ...
                            <form action="settings.php" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="msg-button link" value="<?php echo translate('Save avatar');?>"/>
                            </form>
                        </div>
                        <div class="panel">
                            <h2><?php echo translate('Sms Notification');?></h2>
                            <form action="settings.php" method="post" style="margin-left: 130px;">
...
?>+359<?php 
                                ...
                                <input type="submit" class="msg-button link" value="<?php echo translate('Save');?>" style="margin: 20px 0 0 100px;"/>
                            </form>
                        </div>
                        <div class="panel">
                    ...
                    <div class="security">
                        <div class="panel">
                            ...
                            <form action="settings.php" method="post">
                                ...
                                <input type="submit" class="msg-button link" value="<?php echo translate('Save');?>" style="float: none; margin-bottom: 0px;" />
                            </form>
                        </div>
                        <div class="panel">
                        ...
                        <div class="panel">
                            ...
                            <form action="settings.php" method="post">
                                ...
                                <input type="submit" value="<?php echo translate('Delete');?>" class="msg-button" style="float: none; margin-bottom: 0; margin-top: 10px;" />
                            </form>
                        </div>
                    </div>
                    <div class="planets">
...
/* -- foreach end output */
                                ...
                                <input type="submit" value="<?php echo translate('Save');?>" class="msg-button" style="float: none; margin-bottom: 0;" />
                            </form>
                        </div>
                        <div class="panel">
...
/* -- foreach end output */
                                ...
                                <input type="submit" value="<?php echo translate('Delete');?>" class="msg-button" style="float: none; margin-bottom: 0; margin-top: 20px;" />
                            </form>
                        </div>
                    </div>
                </div>
