...
?>
                            <tr>
                                <td class="id <?php if ((isset($this->scope["area"]) ? $this->scope["area"] : null)) {

if ((isset($this->scope["area"]["race"]) ? $this->scope["area"]["race"]:null) == 1) {
?>conf<?php 
}
else {
?>or<?php 
...
}?> class="active"><?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".name");?> / <label title="<h2><?php echo translate('Player');?>: <?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".user");?></h2><b><?php echo translate('Race');?>:</b> <?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".race");?><br/><b><?php echo translate('Points');?>:</b> <?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".points");?><br/><b><?php echo translate('Last online');?>:</b> <br/><?php echo date('Y-m-d H:i:s', $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".last_update"));?><br/><b><?php echo translate('Rank');?>:</b> <?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".rank");?>"><?php echo $this->readVar("planetsView.".(isset($this->scope["i"]) ? $this->scope["i"] : null).".user");?></label></td>
